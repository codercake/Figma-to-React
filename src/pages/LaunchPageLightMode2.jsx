...
const LaunchPageLightMode2 = () => {
  return (
    <div className="w-full relative bg-main-white overflow-hidden flex flex-col items-start justify-start pt-[33.8px] px-[38px] pb-[152px] box-border gap-[88.9px] leading-[normal] tracking-[normal] text-center text-xl text-darkslategray-200 font-poppins mq450:gap-[22px] mq725:gap-11">
      <img
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 pl-0 pr-px box-border max-w-full">
        <div className="w-[1027px] flex flex-col items-start justify-start min-h-[720px] max-w-full">
          <div className="self-stretch flex flex-col items-center justify-center py-6 px-0 box-border gap-[72px] max-w-full z-[1] mq1025:gap-9 mq725:gap-[18px] mq725:pt-5 mq725:pb-5 mq725:box-border">
            <div className="self-stretch flex flex-col items-center justify-start gap-6 max-w-full text-45xl">
