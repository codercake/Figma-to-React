...
const LaunchPageLightMode31 = () => {
  return (
    <div className="w-full relative bg-main-white overflow-hidden flex flex-col items-start justify-start pt-[33.8px] px-[38px] pb-[280px] box-border gap-[216.9px] leading-[normal] tracking-[normal] text-center text-xl text-main-black font-poppins mq450:gap-[54px] mq725:gap-[108px]">
      <img
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 pl-0 pr-px box-border max-w-full">
        <div className="w-[1027px] flex flex-col items-start justify-start min-h-[464px] max-w-full">
          <div className="self-stretch flex flex-col items-center justify-center py-6 px-0 box-border gap-[72px] max-w-full z-[1] mq450:pt-5 mq450:pb-5 mq450:box-border mq1025:gap-9 mq725:gap-[18px]">
            ...
            />
            <div className="w-[434px] rounded-3xl [background:linear-gradient(99.57deg,_#e6b8d9,_#c9b8e6)] overflow-x-auto hidden flex-row items-center justify-between p-8 box-border gap-5 max-w-full text-left text-45xl">
            ...
            <div className="w-[804px] hidden flex-col items-center justify-center gap-6 max-w-full text-lightgray">
...
export default LaunchPageLightMode31;
